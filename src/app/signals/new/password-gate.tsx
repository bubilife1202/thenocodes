...
import { initialPasswordState, unlockSignalsAdmin } from "./actions";
...
export function PasswordGate() {
  const [state, formAction] = useActionState(unlockSignalsAdmin, initialPasswordState);
    ...
    <section className="rounded-[28px] border border-[#ECE7DF] bg-white p-5 shadow-[0_12px_36px_-28px_rgba(15,118,110,0.25)] sm:p-8">
      <div className="mb-6">
        ...
        <p className="mt-2 text-sm leading-relaxed text-[#6B6760]">
          관리자 비밀번호를 서버에서 검증한 뒤 작성 폼을 표시합니다.
        </p>
      </div>
